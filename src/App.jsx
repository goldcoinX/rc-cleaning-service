...
export default function App() {
  ...
  const WorkerPortal = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex justify-center bg-gray-900">
        <div className="w-full max-w-md bg-white shadow-2xl relative flex flex-col">
          {/* Header */}
  ...
  const ClientPortal = () => {
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center bg-gray-100">
